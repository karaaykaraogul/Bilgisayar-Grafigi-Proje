...
void GuiControl::setScale(glm::vec3* scale)
{
    this->vecScales = scale;
}
void GuiControl::createFrameItems()
{
    ...
    ImGui::SliderFloat3("buyutme",(float*)vecScales,-5.0f,5.0f);

    ImGui::RadioButton("Kare",&secilenSekil,0);ImGui::SameLine();
    ImGui::RadioButton("Kup",&secilenSekil,1);ImGui::SameLine();
    ImGui::RadioButton("Daire",&secilenSekil,2);ImGui::SameLine();
    ImGui::RadioButton("Silindir",&secilenSekil,3);ImGui::SameLine();
    ImGui::RadioButton("Altigen",&secilenSekil,4);ImGui::SameLine();
    ImGui::RadioButton("Ucgen",&secilenSekil,5);ImGui::SameLine();
    ImGui::RadioButton("Piramit",&secilenSekil,6); 
